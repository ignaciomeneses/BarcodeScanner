...
public class CaptureManager {
    ...
    protected void displayFrameworkBugMessageAndExit() {
        ...
        builder.setTitle(activity.getString(mFakeR.getId("string","zxing_app_name")));
        builder.setMessage(activity.getString(mFakeR.getId("string","zxing_msg_camera_framework_bug")));
        builder.setPositiveButton(mFakeR.getId("string","zxing_button_ok"), new DialogInterface.OnClickListener() {
            @Override
