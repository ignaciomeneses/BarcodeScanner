...
public class BarcodeView extends CameraPreview {
    ...
    private final Handler.Callback resultCallback = new Handler.Callback() {
        ...
        public boolean handleMessage(Message message) {
            if (message.what == mFakeR.getId("id","zxing_decode_succeeded")) {
                ...
                return true;
            } else if (message.what == mFakeR.getId("id","zxing_decode_failed")) {
                // Failed. Next preview is automatically tried.
                return true;
            } else if (message.what == mFakeR.getId("id","zxing_possible_result_points")) {
    ...
    private void startDecoderThread() {
        ...
        if (decodeMode != DecodeMode.NONE && isPreviewActive()) {
            ...
            decoderThread = new DecoderThread(getContext(),getCameraInstance(), createDecoder(), resultHandler);
