...
public class CameraInstance {
        ...
        public void run() {
            try {
                ...
                if (readyHandler != null) {
                    readyHandler.obtainMessage(mFakeR.getId("id","zxing_prewiew_size_ready"), getPreviewSize()).sendToTarget();
                }
            } catch (Exception e) {
                notifyError(e);
    ...
    private void notifyError(Exception error) {
        if (readyHandler != null) {
            readyHandler.obtainMessage(mFakeR.getId("id","zxing_camera_error"), error).sendToTarget();
        }
    }
}
