...
public class CompoundBarcodeView extends FrameLayout {
    ...
    private void initialize(AttributeSet attrs) {
        mFakeR = new FakeR(getContext());
        // Get attributes set on view
        TypedArray attributes = getContext().obtainStyledAttributes(attrs, new int[]{mFakeR.getId("styleable", "zxing_view")});
        int scannerLayout = attributes.getResourceId(
                mFakeR.getId("styleable","zxing_view_zxing_scanner_layout"),mFakeR.getId("layout","zxing_barcode_scanner"));

        attributes.recycle();

        inflate(getContext(), scannerLayout, this);

        barcodeView = (BarcodeView) findViewById(mFakeR.getId("id","zxing_barcode_surface"));
        ...
        viewFinder = (ViewfinderView) findViewById(mFakeR.getId("id","zxing_viewfinder_view"));
        ...
        statusView = (TextView) findViewById(mFakeR.getId("id","zxing_status_view"));
    }
    ...
    public BarcodeView getBarcodeView() {
        return (BarcodeView) findViewById(mFakeR.getId("id","zxing_barcode_surface"));
    }
